...
namespace BookStore.Controllers
{
    ...
    [Route("HangHoa/PhieuNhanHang")]
    public class PhieuNhanHangController : Controller
    {
        ...
        public PhieuNhanHangController(
        ...
        public async Task<IActionResult> Index(int? page, int? pageSize)
        {
            ...
            try
            {
                var result = await NonamePaginatedList<PhieuNhanHang>.CreateAsync(
                    _bookStoreData.GetPhieuNhanHang(), page ?? 1, pageSize ?? 10);
